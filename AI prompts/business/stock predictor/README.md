...
This is only an example prompt template, so you may customize it to fit your prompt.
...
- Your actual prompt, organized in meaningful categories, such as Context, Output, Format, Constraints, etc.
